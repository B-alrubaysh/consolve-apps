...
export const SIDEBAR_VISIBILITY = {
  [ROLES.OWNER]: ["dashboard", "blog", "templates", "clients", "services", "landing", "careers", "submissions", "inquiries", "assessments", "users", "settings"],
  [ROLES.ADMIN]: ["dashboard", "blog", "templates", "clients", "services", "landing", "careers", "submissions", "inquiries", "assessments", "users", "settings"],
