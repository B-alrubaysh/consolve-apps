        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-primary mb-4">
              {isAr ? "رؤى كونسولف" : "Consolve Insights"}
            </p>
            <h1 className="text-4xl md:text-6xl font-black text-secondary-foreground leading-tight mb-5">
              {isAr ? "مقالات ورؤى إدارية" : "Management Articles and Insights"}
            </h1>
            <p className="text-secondary-foreground/60 text-lg max-w-xl leading-relaxed">
              {isAr
                ? "محتوى عملي حول الاستراتيجية والعمليات والحوكمة والنمو، يساعد المؤسسات على تشخيص تحدياتها وتحسين قراراتها وأدائها."
