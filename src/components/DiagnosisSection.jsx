...
const COPY = {
  ar: {
    banner: "ابدأ تشخيص شركتك واكتشف الأسباب المحتملة للتحديات التي تؤثر في أدائها.",
    h2_plain: "المشكلة التي تراها...",
    h2_accent: "ليست دائمًا المشكلة الحقيقية.",
    intro: "ابدأ بتشخيص أولي يعتمد على أسئلة تتكيف مع طبيعة نشاطك والتحدي الذي تواجهه. وفي نهاية التشخيص، ستحصل على تقرير يساعدك على فهم الوضع الحالي وتحديد الأسباب المحتملة والخدمات الاستشارية الأنسب.",
    cta: "ابدأ التشخيص",
    cta_note: "يقدّم هذا التشخيص المدعوم بالذكاء الاصطناعي تقييمًا أوليًا، ولا يُغني عن المراجعة الاستشارية التفصيلية.",
    preview_title: "ماذا يتضمن تقرير التشخيص؟",
    maturity: "مرحلة النضج", maturity_v: "متوسطة",
    risk: "مستوى المخاطر", risk_v: "مرتفع",
    axes: "تقييم الجوانب المرتبطة بالتحدي",
    ...
    why: [
      ...
      { t: "تقرير أولي", d: "احصل على تقرير أولي يساعدك على فهم التحدي قبل اتخاذ قرار بشأن مشروع التطوير المناسب." },
    ],
    how_title: "كيف يعمل؟",
    how: [
