          ...
          <div className="md:w-[40%] flex flex-col gap-8">
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-bold text-foreground tracking-tight mb-4 leading-tight">
                {isAr ? "حلول استشارية متكاملة لتحسين الأداء المؤسسي" : "Integrated Consulting Solutions for Organizational Performance"}
              </h2>
              <p className="text-muted-foreground text-base md:text-lg">
                {isAr
                  ? "استعرض مجالاتنا الاستشارية واختر الخدمة المرتبطة بالتحدي الذي تواجهه مؤسستك، من تحسين العمليات والحوكمة إلى الاستراتيجية والتطوير المؤسسي."
